...
public class JavaChess extends JFrame implements MouseListener {
	...
	private Time timer;
	public static JavaChess mainBoard;
	...
	public static void main(String[] args) {
		...
		wr1 = new Rook("WR01", "White_Rook.png", 0);
		wr2 = new Rook("WR02", "White_Rook.png", 0);
		br1 = new Rook("BR01", "Black_Rook.png", 1);
		br2 = new Rook("BR02", "Black_Rook.png", 1);
		wk1 = new Knight("WK01", "White_Knight.png", 0);
		wk2 = new Knight("WK02", "White_Knight.png", 0);
		bk1 = new Knight("BK01", "Black_Knight.png", 1);
		bk2 = new Knight("BK02", "Black_Knight.png", 1);
		wb1 = new Bishop("WB01", "White_Bishop.png", 0);
		wb2 = new Bishop("WB02", "White_Bishop.png", 0);
		bb1 = new Bishop("BB01", "Black_Bishop.png", 1);
		bb2 = new Bishop("BB02", "Black_Bishop.png", 1);
	...
	private JavaChess() {
		...
		temp = new JPanel() {
			...
			public void paintComponent(Graphics g) {
				try {
					image = ImageIO.read(this.getClass().getResource("initialImage.jpg"));
	...
	public void changeTurn() {
		...
		if (!end && timer != null) {
			...
			if (JavaChess.move == "White")
				JavaChess.move = "Black";
			else
				JavaChess.move = "White";
			CHNC.setText(JavaChess.move);
			showPlayer.add(CHNC);
		}
	}
	...
	private boolean willkingbeindanger(Cell fromcell, Cell tocell) {
		...
		if (((King) (newBoardState[getKing(turn).getx()][getKing(turn).gety()].getpiece()))
